...
export function Dialog({ open, onOpenChange, children }: DialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] border border-border bg-card p-6 shadow-lg sm:rounded-lg">
...
export function DialogContent({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) { return <div className={cn(className)} {...props}>{children}</div>; }
